...
operation:
  ...
  sequential_action:
    ...
    - step:
        id: '6'
        object_path: SAPGuiSession("Session").SAPGuiWindow("Maintain Users").SAPGuiEdit("Last
          name")
        action: Set
        default_args: '"Das"'
    ...
    - step:
        id: '7'
        object_path: SAPGuiSession("Session").SAPGuiWindow("Maintain Users").SAPGuiEdit("First
          name")
        action: Set
    ...
    - step:
        id: '8'
        object_path: SAPGuiSession("Session").SAPGuiWindow("Maintain Users").SAPGuiEdit("E-Mail
          Address")
        action: Set
    ...
    - step:
        id: '11'
        object_path: SAPGuiSession("Session").SAPGuiWindow("Maintain Users").SAPGuiEdit("New
          Password")
        action: Set
        default_args: '"********"'
    ...
    - step:
        id: '12'
        object_path: SAPGuiSession("Session").SAPGuiWindow("Maintain Users").SAPGuiEdit("Repeat
          Password")
        action: Set
        default_args: '"********"'
        snapshot: .\Snapshots\ssf4.png
